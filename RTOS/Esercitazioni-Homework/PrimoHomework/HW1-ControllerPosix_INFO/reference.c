...
//Viene usato per scrivere il valore di riferimento!
//Può essere lanciato successivamente per modificare il valore

//Il main prende in ingresso un certo argomento
int main(int argc, char ** argv)
{
    ...
    //Si limita a chiudere la coda poichè viene usata dal controller
