...
void *plant_loop(void *par)
{
	...
	if (ret != 0)
		{
		perror(" Cannot set plant thread CPU affinity ");
		exit(-1);
	}*/
...
void *sensor_driver_loop(void *par)
{
	...
	if (ret != 0)
		{
		perror(" Cannot set sensor thread CPU affinity ");
		exit(-1);
	}*/
...
void *actuator_driver_loop(void *par)
{
	...
	if (ret != 0)
		{
		perror(" Cannot set actuator driver thread CPU affinity ");
		exit(-1);
	}*/
