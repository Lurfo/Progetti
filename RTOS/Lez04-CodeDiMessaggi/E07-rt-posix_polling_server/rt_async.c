...
//Questo è un programma asincrono che viene eseguito quando un utente manda un messaggio da tastiera al polling server, in 
//modo da andare a risvegliarlo
...
int main(void){
	...
	//In quanto sto considerando un processo che ha una certa priorità e non un thread!
	...
	do{
		...
		if(start == 1){
			//Se uso questo ramo, vado ad inviare un messaggio al pollig server!
