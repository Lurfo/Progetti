...
//Vado a schedulare i singoli thread con SCHED_DEADLINE
...
//In questo caso, il singolo thread, nella sua starting routine, imposta la sua policy di scheduling SCHED_OTHER e poi esegue il suo job
void * run (void * par) {
...
//Il main permette solo di andare ad inizializzare i miei valori iniziali!
//NOTA: Non ha senso impostare il parametro priority perchè non devo considerarlo con questo tipo di scheduling!
int main()
{
	pthread_t thread_1;
