...
int main(){
        ...
        //create queues
        int key_queue_gen_filter = ftok("./", 'A');
        int key_queue_filter_checksum = ftok("./", 'B');
        int key_queue_checksum_visual = ftok("./", 'C');
        ...
        int ds_shm = shmget(shm_key, sizeof(struct ProdConsGen), IPC_CREAT | 0644);
